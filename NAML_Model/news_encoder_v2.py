...
from general.Attention.mutilHead_self import MultiHeadSelfAttention , CustomMultiHeadSelfAttention
device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")


class TextEncoder(torch.nn.Module):
    def __init__(self, word_embedding, word_embedding_dim, num_filters,
                 window_size, num_attention_heads, dropout_probability):
        ...
        self.mutilhead_attention = CustomMultiHeadSelfAttention(word_embedding_dim, num_attention_heads,num_filters)
    def forward(self, text):
        ...
        text_vector = self.mutilhead_attention(
